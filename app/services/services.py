...
class PredictionService:
	...
	def perform_prediction(self, home_team: str, away_team: str):
		league = get_league_by_team(home_team)
		model = load(f'{files_folder}/models/{league}_model.joblib')
...
#Helper functions
def get_league_by_team(team: str):
...
def get_team_row(team_name):
    df = pd.read_csv(f'{files_folder}/data/current_data.csv')
